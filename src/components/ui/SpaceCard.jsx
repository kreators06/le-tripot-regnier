    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6">
        <div className="flex items-end justify-between">
          ...
          <motion.div 
            className="w-10 h-10 border border-[#ff8c5a]/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            whileHover={{ scale: 1.1 }}
          >
            <svg className="w-4 h-4 text-[#ff8c5a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
